...
/**
 * 项目：   5anet(BBS)
 * 文件：   class/user/ListMyTopic.class.php
 *
 * 分页列出用户自己发表的主题
 *
 * PHP Version 5
...
if ( file_exists(LANG_PATH.SYSTEM_LANG.'/ListMyTopic.lang.php') ) {
   include_once LANG_PATH.SYSTEM_LANG.'/ListMyTopic.lang.php';
}


class ListMyTopic extends BaseAction {
