...
/**
*  Project Name:  5anet
*  File Name   :  class/admin/SaveUserBlackList.class.php
*
*  保存新的用户黑名单
*  
*  PHP Version 5
...
*  @version:   $Id: SaveUserBlackList.class.php,v 1.1.1.1 2006-08-28 13:09:20 ghw Exp $
...
if ( file_exists(LANG_PATH.SYSTEM_LANG.'/admin/SaveUserBlackList.lang.php') ) {
   include_once LANG_PATH.SYSTEM_LANG.'/admin/SaveUserBlackList.lang.php';
}

class SaveUserBlackList extends AdminBaseAction {
