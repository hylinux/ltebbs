...
/**
 * 项目：   5anet(BBS)
 * 文件：   class/bbs/CloseTopic.class.php
 *
 * 关闭一个主题
 * 在关闭主题之前要判断用户的身份。
 * 登录不需判断。
 ...
 * @version:   $Id: CloseTopic.class.php,v 1.1.1.1 2006-08-28 13:09:20 ghw Exp $
...
if ( file_exists(LANG_PATH.SYSTEM_LANG.'/CloseTopic.lang.php') ) {
   include_once LANG_PATH.SYSTEM_LANG.'/CloseTopic.lang.php';
}

class CloseTopic extends BaseAction {
   /**
    * 数据库的连接
    */
   public $db;
