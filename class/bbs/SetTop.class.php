 ...
 * @version:   $Id: SetTop.class.php,v 1.1.1.1 2006-08-28 13:09:20 ghw Exp $
...
if ( file_exists(LANG_PATH.SYSTEM_LANG.'/SetTop.lang.php') ) {
   include_once LANG_PATH.SYSTEM_LANG.'/SetTop.lang.php';
}

class SetTop extends BaseAction {
   ...
   public function run() {
      ...
      $sql = 'update bbs_subject set is_top=1 where id=?';
      $sth = $this->db->Prepare($sql);
